EnlightmentProd::Application.configure do
  ...
  config.assets.precompile += %w( admin/admin_scripts.js admin/admin_styles.css merchant/merchant_scripts.js merchant/merchant_styles.css )
  #config.assets.precompile << 'admin_scripts.js'
