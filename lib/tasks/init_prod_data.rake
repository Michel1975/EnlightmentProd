...
namespace :db do
  ...
  task load_start_data: :environment do
    ...
    store = MerchantStore.create!(description: 'Butik til anvendelse i backend-administration', email: "admin_user@clubnovus.dk", short_description: '', phone: "24600819", street: 'Klostervangen', house_number: '34', 
